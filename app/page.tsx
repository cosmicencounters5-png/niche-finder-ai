...
export default function Home(){
  ...
  /* ---------- DOPAMINE UNLOCK (BLUEPRINT DELAY) ---------- */
        ...
        {(reveal && data?.mode==="idea") && (
          ...
          <div className="bg-zinc-900 p-6 rounded-xl space-y-4 border border-green-500/20 shadow-lg shadow-green-900/20">
            ...
            <p className="text-xs opacity-50">
              Generated by Oracle X Intelligence
            </p>
            ...
            <div className="bg-green-900/30 p-3 rounded-lg text-sm">
              ...
              ⚫ Oracle X Confidence Level: HIGH  
              <br/>
              Signal strength decreasing as market catches up.

            </div>

            {/* DOPAMINE DELAYED BLUEPRINT */}
