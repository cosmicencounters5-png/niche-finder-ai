    ...
    <main className="min-h-screen bg-black text-white px-4 py-10 flex justify-center">
      ...
      <div className="max-w-xl w-full space-y-6">
        ...
        {(reveal && data?.mode==="idea") && (
          ...
          <div className="bg-zinc-900 p-6 rounded-xl space-y-4 shadow-lg shadow-green-900/20 border border-green-500/20">

            <p className="text-xs opacity-50">Generated by Oracle X Intelligence</p>
